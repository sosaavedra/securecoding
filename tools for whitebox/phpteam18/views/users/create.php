      ...
      <div class="container">
        ...
        <?php if($_POST != NULL) { ?>
          <form action="<?php echo URL . 'users/register'?>" method='POST'>
            ...
            <br/>
            <strong>How you would like to receive your TAN numbers</strong>
            <br/>
            <div class="radio">
             <label><input type="radio" name="useSCS" value="email" checked><strong>Email</strong> </label>
            </div>
            <div class="radio">
			 <label><input type="radio" name="useSCS" value="SCS"><strong>Smart Card</strong></label>
            </div>
